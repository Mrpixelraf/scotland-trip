...
获取日2026-09-14。地理坐标用于区域比较，4位小数不代表停车精度。
...
- [OSRM](https://project-osrm.org/)，原请求和模型时长保存在`roads.json`。西线使用Callander、Crianlarich、Oban、Lochgilphead和Tarbert途经点，避免将渡轮当作默认行驶路径。
